  ...
  return (
    <div className="relative w-full h-full">
      <section className="top-section fixed w-screen h-full">
        <video className="absolute top-0 left-0 w-full h-full object-cover" src={getBlobUrl('9nyheK4phlsnY9biZxbj2X9yS1y6_PZpYbFz2x5tDYQ')} autoPlay loop muted />
        ...
        <section className="h-screen bg-fixed bg-cover bg-center bg-[#98efe4]">
          <div className="max-w-7xl h-full m-auto py-5 flex flex-col items-center justify-center">
            <div className="w-full h-full grid grid-cols-6 gap-4 bg-white border border-black rounded-lg p-5">
              {
                books.map((book) => (
                  <Tooltip color="cyan" placement="bottom" title={book.title} key={book.id}>
                    <div className="flex flex-col items-center gap-1" onClick={() => navigator('/book/' + book.id)}>
                      <Image
